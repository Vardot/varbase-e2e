...
**509 built-in steps** across **45 step files**, including the Drupal and Varbase packs. **282 example scenarios / 1,372 step executions** in the bundled suite, all green on chromium.
...
| [Step catalogue](steps/README.md) | All 509 steps, 45 category pages under `steps/`, generated from the source |
...
> [`@webship-js/diffy-steps`](https://github.com/webship/diffy-steps) — install
> it alongside varbase-e2e and add its step-definition path to `cucumber.js`.
> `*-steps` packs built for the harness this grew from work unchanged.
...
│       ├── drupal-drimage-improved.steps.js (13) # Drimage Improved: loaded / lazy / sized / webp / noscript / figure / caption / alt / title, no selectors
